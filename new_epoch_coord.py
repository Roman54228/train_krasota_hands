"""
Модуль для координатных преобразований
"""
import numpy as np
import cv2
...
class CoordinateTransformer:
    ...
    def __init__(self):
        # Параметры камеры
        # self.K = np.array([[1125.862, 0, 937.379],
        #                   [0, 1126.107, 575.060],
        #                   [0, 0, 1]], dtype=np.float64)
        
        # # Параметры дисторсии
        # self.dist = np.array([0.078378, -0.125571, 0.077979, -0.000242, -0.000301])
    ...
    def get_world_coordinates_3d(self, keypoint_x: int, keypoint_y: int, depth: float) -> Tuple[float, float, float]:
        ...
        Returns:
            Tuple[float, float, float]: Мировые координаты (X, Y, Z)
        """
        return self.pixel_to_world_3d(keypoint_x, keypoint_y, depth)
